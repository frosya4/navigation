...
const minskLocations = [
    ...
    },
    {
        ...
        description: "Главный мемориальный комплекс Минска. 38-метровый монумент with орденом Победы увенчивает площадь, у основания которого горит Вечный огонь в память о воинах Великой Отечественной войны. Под площадью — Музей Победы.",
